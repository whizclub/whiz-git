...
export default function APSubInspectorTestsPage() {
  ...
  const checkAuthAndLoadTests = async () => {
    try {
      ...
      const testsRes = await fetch('/api/admin/tests?category=AP Sub-Inspector');
      if (testsRes.ok) {
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            🎖️ AP Sub-Inspector Mock Tests
          </h1>
          <p className="text-gray-600">Create and manage AP Sub-Inspector practice tests</p>
        </div>
        <button
        ...
        {tests.length === 0 ? (
          <div className="col-span-full bg-white rounded-xl p-12 text-center shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              Create your first AP Sub-Inspector mock test to get started
            </p>
            <button
              onClick={() => setShowModal(true)}
            ...
            <form onSubmit={handleCreateTest} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., AP Sub-Inspector Mock Test 1"
                />
              </div>
